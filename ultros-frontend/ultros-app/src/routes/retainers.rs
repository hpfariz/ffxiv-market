    ...
    view! {
        <div class="panel p-4 rounded-xl">
            ...
            <table class="w-full">
                <thead>
                    <tr>
                        <th scope="col">{t!(i18n, retainers_hq)}</th>
                        <th scope="col">{t!(i18n, retainers_item)}</th>
                        <th scope="col">{t!(i18n, retainers_price_per_unit)}</th>
                        <th scope="col">{t!(i18n, retainers_quantity)}</th>
